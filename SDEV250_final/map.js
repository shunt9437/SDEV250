...
function setUpPage() {
    // document.querySelector("ul li:first-of-type").addEventListener("click", loadSetup, false);
    // document.querySelector("ul li:last-of-type").addEventListener("click", loadDirections, false);
    document.getElementById("directionsbtn").addEventListener("click", loadDirections,false)
...
// function loadSetup() {
//     document.querySelector("ul li:first-of-type").className = "current";
//     document.querySelector("ul li:last-of-type").className = "";
...
function loadDirections(string) {
    // document.querySelector("ul li:first-of-type").className = "";
    // document.querySelector("ul li:last-of-type").className = "current";
    document.getElementById("directionsbtn").className = "current";
...
//add event listeners am move object when user starts dragging
