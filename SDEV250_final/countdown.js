...
function updateCountdown() {
    ...
    //year
    var yearUntil = Math.floor(dateObject.getFullYear() - dateToday.getFullYear());
    document.getElementById("year").innerHTML = yearUntil;

    //months
    var monthUntil = Math.floor((dateTo - dateFrom) / 2.628e+9);
    // console.log(dateToday.getMonth());
    // console.log(dateObject.getMonth());
    // console.log(monthUntil);
    document.getElementById("months").innerHTML = monthUntil;


    // days
    var daysUntil = Math.floor((dateTo - dateFrom) / 86400000);
    document.getElementById("days").innerHTML = daysUntil;
    ...
    document.getElementById("hours").innerHTML = ":" + hoursUntil;
    ...
    document.getElementById("minutes").innerHTML = ":" + minutesUntil;
    ...
    document.getElementById("seconds").innerHTML = ":" + secondsUntil;
